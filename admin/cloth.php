...
if(isset($_REQUEST['cloth_id'])){
    ...
    $sql = "UPDATE clothes SET collect = ? WHERE cloth_id = ?";
    $result = $conn->prepare($sql);
    if($result->execute(array(1, $cloth_id))){
...
<div id="admin-content">
    <div class="container">
        <div class="row">
          <h4 class="w3-center">Clothes Requests</h4>
            <div class="col-md-12">
                <table class="content-table">
                    ...
                    ?>
                        <tr>
                            ...
                            <td ><a href='cloth.php?cloth_id=<?php if(isset($row['cloth_id'])){ echo $row['cloth_id']; } ?>' class="w3-btn w3-green">Collect</a></td>
