...
<div id="admin-content">
    <div class="container">
        <h4 class="w3-center">All Food Donated</h4>   
        <div class="row">
            <div class="col-md-12">
...
<div class="w3-row pagination">
  <?php
    ...
    if($result2->rowCount()){
      ...
      echo '<ul>';
      if($page > 1){
        echo '<li class="w3-button w3-green"><a href="food-collect.php?page='.($page-1).'" class="w3-blue p-3">Previous</a></li>';
      }
      ...
      for($i = 1; $i <= $total_pages; $i++){
        ...
        echo '<li class="w3-button w3-green '.$active.'"><a href="food-collect.php?page='.$i.'" class="w3-blue p-3" style="padding:100%;">'.$i.'</a></li>';
      }
      if($total_pages > $page){
        echo '<li class="w3-button w3-green"><a href="food-collect.php?page='.($page + 1).'" class="w3-blue p-3">Next</a></li>';
      }
      echo '</ul>';
    }
  ?>
